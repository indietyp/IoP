...
def init_sensor():
  ...
  # get current_data
  with urllib.request.urlopen('http://127.0.0.1:2902/get/plant/' + session['plant'] + '/sensor/' + session['sensor'] + '/data/current') as response:
  ...
  with urllib.request.urlopen('http://127.0.0.1:2902/get/plant/' + session['plant'] + '/sensor/' + session['sensor'] + '/high/today/yes') as response:
  ...
  with urllib.request.urlopen('http://127.0.0.1:2902/get/plant/' + session['plant'] + '/sensor/' + session['sensor'] + '/range') as response:
