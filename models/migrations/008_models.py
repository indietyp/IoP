...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    class MailAccount(pw.Model):
        ...
        encryption = pw.CharField(max_length=255)
        port = pw.CharField(max_length=255)
        transport = pw.CharField(max_length=255)
        password = pw.ForeignKeyField(db_column='password_id', rel_model=migrator.orm['keychain'], to_field='id')
