...
def migrate(migrator, database, fake=False, **kwargs):
    ...
    migrator.change_fields('sensorstatus', status=pw.BooleanField(default=False))


def rollback(migrator, database, fake=False, **kwargs):
    """Write your rollback migrations here."""

    migrator.change_fields('sensorstatus', status=pw.CharField(default='low', max_length=255))
